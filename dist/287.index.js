...
/* harmony export */   "checkLabels": () => (/* binding */ checkLabels)
/* harmony export */ });
...
const checkLabels = ({ pull_number, contains_all_labels }) => {
    return _octokit__WEBPACK_IMPORTED_MODULE_1__/* .octokit.pulls.get */ .K.pulls.get(Object.assign({ pull_number: Number(pull_number) }, _actions_github__WEBPACK_IMPORTED_MODULE_2__.context.repo))
        .then(response => {
        ...
        (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__.setFailed)(`Pull request does not have all these labels: ${contains_all_labels}`);
        return false;
    });
};
