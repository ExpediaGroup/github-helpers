...
class SetDeploymentStatus extends _types_generated__WEBPACK_IMPORTED_MODULE_3__/* .HelperInputs */ .s {
    constructor() {
        super(...arguments);
        this.state = '';
        this.environment = '';
...
const setDeploymentStatus = async ({ sha, state, environment, description, target_url, environment_url }) => {
    ...
    if (deployment_id) {
        return _octokit__WEBPACK_IMPORTED_MODULE_2__/* .octokit.repos.createDeploymentStatus */ .K.repos.createDeploymentStatus({
            state: state,
            deployment_id,
            description,
            target_url,
