...
var require_es5 = __commonJS(function(exports2, module2) {
  var isES5 = function() {
...
var require_schedule = __commonJS(function(exports2, module2) {
...
var require_queue = __commonJS(function(exports2, module2) {
...
var require_thenables = __commonJS(function(exports2, module2) {
      ...
      if (isObject2(obj2)) {
        ...
        if (then === errorObj2) {
          ...
          if (isAnyBluebirdPromise(obj2)) {
            ...
            obj2._then(ret2._fulfill, ret2._reject, undefined, ret2, null);
            return ret2;
          }
...
var require_promise_array = __commonJS(function(exports2, module2) {
...
var require_context = __commonJS(function(exports2, module2) {
...
var require_debuggability = __commonJS(function(exports2, module2) {
      ...
      try {
        if (typeof CustomEvent === "function") {
          ...
          return function(name, event) {
            ...
            es52.defineProperty(domEvent, "promise", { value: event.promise });
            es52.defineProperty(domEvent, "reason", { value: event.reason });
    ...
    var captureStackTrace = function stackDetection() {
      ...
      if (typeof Error.stackTraceLimit === "number" && typeof Error.captureStackTrace === "function") {
        ...
        return function(receiver2, ignoreUntil) {
          Error.stackTraceLimit += 6;
          captureStackTrace(receiver2, ignoreUntil);
          Error.stackTraceLimit -= 6;
        };
      }
      var err = new Error;
...
var require_catch_filter = __commonJS(function(exports2, module2) {
...
var require_finally = __commonJS(function(exports2, module2) {
  module2.exports = function(Promise2, tryConvertToPromise, NEXT_FILTER) {
    ...
    Promise2.prototype._passThrough = function(handler, type, success, fail) {
...
var require_nodeback = __commonJS(function(exports2, module2) {
  var util = require_util();
...
var require_method = __commonJS(function(exports2, module2) {
...
var require_bind = __commonJS(function(exports2, module2) {
  module2.exports = function(Promise2, INTERNAL, tryConvertToPromise, debug) {
    ...
    Promise2.prototype.bind = function(thisArg) {
      ...
      if (maybePromise instanceof Promise2) {
        ...
        target._then(INTERNAL, targetRejected, undefined, ret2, context);
        maybePromise._then(bindingResolved, bindingRejected, undefined, ret2, context);
...
var require_cancel = __commonJS(function(exports2, module2) {
...
var require_direct_resolve = __commonJS(function(exports2, module2) {
  module2.exports = function(Promise2) {
    function returner() {
      return this.value;
    }
    ...
    Promise2.prototype["throw"] = Promise2.prototype.thenThrow = function(reason) {
      return this._then(thrower2, undefined, undefined, { reason }, undefined);
    };
    Promise2.prototype.catchThrow = function(reason) {
      if (arguments.length <= 1) {
        return this._then(undefined, thrower2, undefined, { reason }, undefined);
      } else {
...
var require_synchronous_inspection = __commonJS(function(exports2, module2) {
  module2.exports = function(Promise2) {
...
var require_join = __commonJS(function(exports2, module2) {
...
`);
    ...
    Promise2.join = function() {
        ...
        if (true) {
          if (last <= 8 && canEvaluate2) {
            ...
            for (var i = 0;i < last; ++i) {
              var maybePromise = tryConvertToPromise(arguments[i], ret2);
              if (maybePromise instanceof Promise2) {
                maybePromise = maybePromise._target();
                var bitField = maybePromise._bitField;
                if ((bitField & 50397184) === 0) {
                  maybePromise._then(callbacks[i], reject, undefined, ret2, holder);
                  promiseSetters[i](maybePromise, holder);
                  holder.asyncNeeded = false;
                } else if ((bitField & 33554432) !== 0) {
                  callbacks[i].call(ret2, maybePromise._value(), holder);
                } else if ((bitField & 16777216) !== 0) {
                ...
                callbacks[i].call(ret2, maybePromise, holder);
              }
            }
      ...
      return fn !== undefined ? ret2.spread(fn) : ret2;
    };
  };
});

// node_modules/bluebird/js/release/call_get.js
var require_call_get = __commonJS(function(exports2, module2) {
...
var require_generators = __commonJS(function(exports2, module2) {
  module2.exports = function(Promise2, apiRejection, INTERNAL, tryConvertToPromise, Proxyable, debug) {
    ...
    function promiseFromYieldHandler(value, yieldHandlers, traceParent) {
      for (var i = 0;i < yieldHandlers.length; ++i) {
        ...
        var result = tryCatch2(yieldHandlers[i])(value);
    ...
    PromiseSpawn.prototype._promiseCancelled = function() {
      ...
      if (!implementsReturn) {
        ...
        this._promise._pushContext();
        result = tryCatch2(this._generator["return"]).call(this._generator, undefined);
        this._promise._popContext();
      }
...
var require_map = __commonJS(function(exports2, module2) {
...
var require_nodeify = __commonJS(function(exports2, module2) {
  module2.exports = function(Promise2) {
    var util = require_util();
    var async = Promise2._async;
    var tryCatch2 = util.tryCatch;
    ...
    function successAdapter(val, nodeback) {
      var promise = this;
      var receiver2 = promise._boundValue();
      var ret2 = val === undefined ? tryCatch2(nodeback).call(receiver2, null) : tryCatch2(nodeback).call(receiver2, null, val);
      if (ret2 === errorObj2) {
        async.throwLater(ret2.e);
      }
    }
...
var require_promisify = __commonJS(function(exports2, module2) {
  module2.exports = function(Promise2, INTERNAL) {
    var THIS = {};
    var util = require_util();
...
`;
            ...
            ret2 = receiver2 === undefined ? `ret = callback({{args}}, nodeback); break;
...
`);
    ...
    function makeNodePromisifiedClosure(callback, receiver2, _, fn, __, multiArgs) {
      ...
      function promisified() {
        ...
        try {
          cb.apply(_receiver, withAppended2(arguments, fn));
        } catch (e) {
...
var require_props = __commonJS(function(exports2, module2) {
...
`);
        ...
        ret2 = castValue._then(Promise2.props, undefined, undefined, undefined, undefined);
      } else {
...
var require_race = __commonJS(function(exports2, module2) {
  module2.exports = function(Promise2, INTERNAL, tryConvertToPromise, apiRejection) {
    ...
    function race(promises, parent) {
      ...
      for (var i = 0, len = promises.length;i < len; ++i) {
        ...
        Promise2.cast(val)._then(fulfill, reject, undefined, ret2, null);
      }
      return ret2;
    }
...
var require_reduce = __commonJS(function(exports2, module2) {
  module2.exports = function(Promise2, PromiseArray, apiRejection, tryConvertToPromise, INTERNAL, debug) {
    var util = require_util();
    var tryCatch2 = util.tryCatch;
    ...
    function gotValue(value) {
      ...
      var promiseCreated = promise._popContext();
      debug.checkForgottenReturns(ret2, promiseCreated, array._eachValues !== undefined ? "Promise.each" : "Promise.reduce", promise);
      return ret2;
    }
  };
});
...
var require_settle = __commonJS(function(exports2, module2) {
...
var require_some = __commonJS(function(exports2, module2) {
...
var require_timers = __commonJS(function(exports2, module2) {
  module2.exports = function(Promise2, INTERNAL, debug) {
    ...
    var delay = Promise2.delay = function(ms, value) {
      ...
      var handle;
      if (value !== undefined) {
        ret2 = Promise2.resolve(value)._then(afterValue, null, null, ms, undefined);
    ...
    Promise2.prototype.timeout = function(ms, message) {
      ...
      if (debug.cancellation()) {
        parent = this.then();
        ret2 = parent._then(successClear, failureClear, undefined, handleWrapper, undefined);
        ret2._setOnCancel(handleWrapper);
      } else {
        ret2 = this._then(successClear, failureClear, undefined, handleWrapper, undefined);
      }
      return ret2;
    };
  };
...
var require_using = __commonJS(function(exports2, module2) {
  module2.exports = function(Promise2, apiRejection, tryConvertToPromise, createContext, INTERNAL, debug) {
    ...
    Promise2.using = function() {
      ...
      var resultPromise = Promise2.all(reflectedResources).then(function(inspections) {
        ...
        promise._pushContext();
        fn = tryCatch2(fn);
        var ret2 = spreadArgs ? fn.apply(undefined, inspections) : fn(inspections);
        var promiseCreated = promise._popContext();
...
var require_any = __commonJS(function(exports2, module2) {
  module2.exports = function(Promise2) {
...
var require_each = __commonJS(function(exports2, module2) {
  module2.exports = function(Promise2, INTERNAL) {
...
var require_filter = __commonJS(function(exports2, module2) {
  module2.exports = function(Promise2, INTERNAL) {
...
var require_promise = __commonJS(function(exports2, module2) {
...
`);
    ...
    Promise2.prototype.reflect = function() {
      return this._then(reflectHandler2, reflectHandler2, undefined, this, undefined);
    };
    ...
    Promise2.prototype._receiverAt = function(index) {
      ...
      if (ret2 === UNDEFINED_BINDING) {
        return;
      } else if (ret2 === undefined && this._isBound()) {
...
var require_bluebird = __commonJS(function(exports2, module2) {
  var old;
...
export { require_bluebird };

//# debugId=042BD5D5F630B2EE64756E2164756E21
