...
var require_light = __commonJS(function(exports, module) {
  (function(global2, factory) {
    ...
    Job = class Job {
      constructor(task, args, options, jobDefaults, rejectOnDrop, Events, _states, Promise2) {
        this.task = task;
        this.args = args;
      ...
      class Bottleneck {
        ...
        async _addToQueue(job) {
          ...
          if (blocked) {
            ...
            shifted = strategy === Bottleneck.prototype.strategy.LEAK ? this._queues.shiftLastFrom(options.priority) : strategy === Bottleneck.prototype.strategy.OVERFLOW_PRIORITY ? this._queues.shiftLastFrom(options.priority + 1) : strategy === Bottleneck.prototype.strategy.OVERFLOW ? job : undefined;
            if (shifted != null) {
              shifted.doDrop();
            }
...
//# debugId=02850AEE52B8611564756E2164756E21
