...
const addPrApprovalLabel = ({ teams, login, pull_number }) => __awaiter(void 0, void 0, void 0, function* () {
    const coreMemberLogins = yield (0,_utils_get_core_member_logins__WEBPACK_IMPORTED_MODULE_3__/* .getCoreMemberLogins */ .c)(pull_number, teams === null || teams === void 0 ? void 0 : teams.split('\n'));
