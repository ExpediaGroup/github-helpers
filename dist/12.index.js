...
class DeleteDeployment extends _types_generated__WEBPACK_IMPORTED_MODULE_3__/* .HelperInputs */ .s {
    constructor() {
        super(...arguments);
        this.sha = '';
        this.environment = '';
...
const deleteDeployment = async ({ sha, environment }) => {
    const { data } = await _octokit__WEBPACK_IMPORTED_MODULE_2__/* .octokit.repos.listDeployments */ .K.repos.listDeployments({
        sha,
        environment,
    ...
    if (deployment_id) {
        ...
        return Promise.all([
            _octokit__WEBPACK_IMPORTED_MODULE_2__/* .octokit.repos.deleteDeployment */ .K.repos.deleteDeployment({
                deployment_id,
                ..._actions_github__WEBPACK_IMPORTED_MODULE_1__.context.repo,
                ..._constants__WEBPACK_IMPORTED_MODULE_0__/* .GITHUB_OPTIONS */ .Cc
            }),
            _octokit__WEBPACK_IMPORTED_MODULE_2__/* .octokit.repos.deleteAnEnvironment */ .K.repos.deleteAnEnvironment({
