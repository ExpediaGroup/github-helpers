...
const run = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const helperModule = yield Promise.resolve().then(() => __importStar(require(`../src/helpers/${helper}`)));
...
const getInputsFromFile = (yamlContents) => Object.keys(yaml.load(yamlContents).inputs);
