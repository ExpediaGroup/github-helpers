...
const prIsSafeToMerge = (pullRequest, { paths, override_filter_paths, override_filter_globs }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (shouldOverrideSafetyCheck) {
        _actions_core__WEBPACK_IMPORTED_MODULE_3__.error(`This branch is out of date on one ore more files critical to the repo! Please update ${ref} with ${default_branch}.`);
        return false;
    }
