"use strict";
exports.id = 676;
exports.ids = [676,499,461,61,209];
exports.modules = {
...
// EXTERNAL MODULE: ./src/helpers/approvals-satisfied.ts
var approvals_satisfied = __webpack_require__(4499);
...
const manageMergeQueue = ({ login, slack_webhook_url } = {}) => manage_merge_queue_awaiter(void 0, void 0, void 0, function* () {
    ...
    const jumpQueueRequested = pullRequest.labels.find(label => label.name === constants/* JUMP_THE_QUEUE_PR_LABEL */.nJ);
    ...
    if (!prAlreadyInQueue) {
        ...
        if (!allRequiredApprovalsAreMet) {
            ...
            return (0,create_pr_comment.createPrComment)({
