...
/* harmony export */   "UpdateCheckResult": () => (/* binding */ UpdateCheckResult),
/* harmony export */   "updateCheckResult": () => (/* binding */ updateCheckResult)
/* harmony export */ });
...
class UpdateCheckResult extends _types_generated__WEBPACK_IMPORTED_MODULE_2__/* .HelperInputs */ .s {
    constructor() {
        super(...arguments);
        this.context = '';
        this.sha = '';
...
const updateCheckResult = async ({ context, sha, state, description }) => {
    const checks = await _octokit__WEBPACK_IMPORTED_MODULE_1__/* .octokit.checks.listForRef */ .K.checks.listForRef({
        ref: sha,
        check_name: context,
    ...
    return _octokit__WEBPACK_IMPORTED_MODULE_1__/* .octokit.checks.update */ .K.checks.update({
        check_run_id,
        conclusion: state,
        output: {
