...
const closeStalePullRequests = ({ threshold }) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield _octokit__WEBPACK_IMPORTED_MODULE_1__/* .octokit.pulls.list */ .K.pulls.list(Object.assign({ state: 'open', per_page: 100 }, _actions_github__WEBPACK_IMPORTED_MODULE_0__.context.repo));
