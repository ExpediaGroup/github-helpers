...
const generateCardParams = (filteredColumn, note) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (note) {
        return Object.assign(Object.assign({ column_id: filteredColumn === null || filteredColumn === void 0 ? void 0 : filteredColumn.id, note }, _actions_github__WEBPACK_IMPORTED_MODULE_2__.context.repo), { headers: {
                accept: 'application/vnd.github.v3+json'
            } });
    }
    return Object.assign(Object.assign({ column_id: filteredColumn.id, content_id: pullRequest.id, content_type: 'PullRequest', note }, _actions_github__WEBPACK_IMPORTED_MODULE_2__.context.repo), { headers: {
            accept: 'application/vnd.github.v3+json'
        } });
});
