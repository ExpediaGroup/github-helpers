...
function F(e, t) {
  ...
  return n === undefined ? null : P.has(n) ? p(true, t.slice(1)) : E.has(n) ? p(false, t.slice(1)) : t.length === 1 ? p(false, t) : p(true, t);
}
...
function A(e, t) {
  return t.isWrite && t.value !== undefined ? { key: t.key, value: t.value, scope: e } : { key: t.key, scope: e };
}
function M(e) {
  const t = e?.indexOf("=") || -1;
  return !e || t < 0 ? null : {
...
function $(e, t, n) {
  ...
  return e === "config" && D(o, N(t), F(t, n)), o;
}
function D(e, t, n) {
  if (n === null)
    return;
  ...
  for (let s = 0;s < n.length; s++) {
    ...
    if (r) {
      ...
      if (a && ![...a].every((w) => t.has(w)))
        return o.push({ name: `-${l}`, value: a, needsNext: false }), o;
    }
...
function j(e, t = []) {
  ...
  for (;n < e.length; ) {
    ...
    for (const r of s) {
      ...
      r.needsNext && a.value === undefined && l < e.length && (a.value = String(e[l]), a.absorbedNext = true, l++), t.push(a);
    }
    n = l;
  }
...
function z({ value: e, name: t }) {
  return e !== undefined ? { name: t, value: e } : { name: t };
}
var _ = {
...
function* J(e) {
  ...
  for (let n = 0;n < t; n++) {
    ...
    o !== undefined && (yield { key: o.toLowerCase().trim(), value: s, scope: "env" });
  }
}
function* Q(e) {
...
function blockUnsafeOperationsPlugin(options = {}) {
  return {
    type: "spawn.args",
    action(args, { env }) {
      for (const vulnerability of te(args, env)) {
...
//# debugId=C4534D9C0A51F7C064756E2164756E21
