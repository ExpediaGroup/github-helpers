...
const createBatchedCommitMessage = () => {
    const eventPayload = _actions_github__WEBPACK_IMPORTED_MODULE_0__/* .context */ ._.payload;
    if (!('commits' in eventPayload)) {
        (0,_actions_core__WEBPACK_IMPORTED_MODULE_1__/* .error */ .z3)('No commits found in the event payload.');
        return;
    }
