...
getInputsFromFile.mockReturnValue(['input1', 'input2', 'input3']);
getInput.mockImplementation(input => (input === 'input2' ? '' : input));
...
//# sourceMappingURL=get-action-inputs.test.js.map