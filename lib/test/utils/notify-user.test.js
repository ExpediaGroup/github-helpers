...
const title = 'title';
const html_url = 'url';
octokit.users.getByUsername.mockImplementation(() => __awaiter(void 0, void 0, void 0, function* () {
    return ({
        data: {
            email: assigneeEmail
        }
...
axios.post.mockResolvedValue({ data: 'request succeeded' });
describe('notifyUser', () => {
    const pull_number = 123;
    const slack_webhook_url = 'https://hooks.slack.com/workflows/1234567890';
    beforeEach(() => __awaiter(void 0, void 0, void 0, function* () {
        yield notifyUser({ login, pull_number, slack_webhook_url });
    }));
...
//# sourceMappingURL=notify-user.test.js.map