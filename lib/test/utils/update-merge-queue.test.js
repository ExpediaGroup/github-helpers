...
octokit.pulls.get.mockImplementation((input) => __awaiter(void 0, void 0, void 0, function* () {
    return ({
        data: {
...
describe('updateMergeQueue', () => {
    describe('pr merge case', () => {
        ...
        it('should call add labels with correct params', () => {
            ...
            expect(octokit.issues.addLabels).toHaveBeenCalledWith(Object.assign({ labels: ['QUEUED FOR MERGE #2'], issue_number: 456 }, context.repo));
        });
    ...
    describe('middle pr taken out of queue case', () => {
        ...
        it('should call add labels with correct params', () => {
            expect(octokit.issues.addLabels).not.toHaveBeenCalledWith(Object.assign({ labels: ['QUEUED FOR MERGE #0'], issue_number: 123 }, context.repo));
            expect(octokit.issues.addLabels).toHaveBeenCalledWith(Object.assign({ labels: ['QUEUED FOR MERGE #2'], issue_number: 456 }, context.repo));
        });
        it('should call remove label with correct params', () => {
...
//# sourceMappingURL=update-merge-queue.test.js.map