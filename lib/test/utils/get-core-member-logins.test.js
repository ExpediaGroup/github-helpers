...
jest.mock('@actions/github', () => ({
    ...
    getOctokit: jest.fn(() => ({
        rest: {
            ...
            teams: {
                listMembersInOrg: jest.fn((input) => __awaiter(void 0, void 0, void 0, function* () { return ownerMap[input.team_slug]; }))
            }
        }
    }))
}));
...
describe('getCoreMemberLogins', () => {
    describe('codeowners tests', () => {
        describe('only some codeowners case', () => {
            ...
            it('should return expected result', () => __awaiter(void 0, void 0, void 0, function* () {
                const result = yield getCoreMemberLogins(pull_number);
    ...
    describe('specified teams case', () => {
        ...
        it('should return expected result', () => __awaiter(void 0, void 0, void 0, function* () {
            const result = yield getCoreMemberLogins(pull_number, teams);
            expect(result).toEqual(['user1', 'user2', 'user3']);
        }));
    });
});
//# sourceMappingURL=get-core-member-logins.test.js.map