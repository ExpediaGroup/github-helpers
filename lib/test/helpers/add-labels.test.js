...
describe('addLabels', () => {
    ...
    it('should call addLabels with correct params', () => {
        expect(octokit.issues.addLabels).toHaveBeenCalledWith(Object.assign({ labels: labels.split('\n'), issue_number: 123 }, context.repo));
    });
});
//# sourceMappingURL=add-labels.test.js.map