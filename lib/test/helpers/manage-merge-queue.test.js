...
describe('manageMergeQueue', () => {
    describe('pr merged case', () => {
        ...
        beforeEach(() => __awaiter(void 0, void 0, void 0, function* () {
            octokit.pulls.list.mockImplementation(({ page }) => __awaiter(void 0, void 0, void 0, function* () {
                return ({
    ...
    describe('pr ready for merge case', () => {
        ...
        it('should call addLabels with correct params', () => {
            expect(octokit.issues.addLabels).toHaveBeenCalledWith(Object.assign({ labels: ['QUEUED FOR MERGE #2'], issue_number: 123 }, context.repo));
        });
    ...
    describe('pr ready for merge case queued #1', () => {
        ...
        it('should call addLabels with correct params', () => {
            expect(octokit.issues.addLabels).toHaveBeenCalledWith(Object.assign({ labels: ['QUEUED FOR MERGE #1'], issue_number: 123 }, context.repo));
        });
        it('should enable auto-merge', () => {
            expect(octokitGraphql).toHaveBeenCalled();
        });
    ...
    describe('slack reminder integration', () => {
        ...
        const queuedPrs = [{ labels: [{ name: READY_FOR_MERGE_PR_LABEL }] }];
        it('should notify user if queue position 1', () => __awaiter(void 0, void 0, void 0, function* () {
            octokit.pulls.list.mockImplementation(({ page }) => __awaiter(void 0, void 0, void 0, function* () {
                return ({
                    data: page === 1 ? queuedPrs : []
                });
            ...
            yield manageMergeQueue({ login, slack_webhook_url });
            expect(notifyUser).toHaveBeenCalled();
        }));
        it('should not notify user if queue position greater than 2', () => __awaiter(void 0, void 0, void 0, function* () {
            const queuedPrs = [
                { labels: [{ name: READY_FOR_MERGE_PR_LABEL }] },
                { labels: [{ name: READY_FOR_MERGE_PR_LABEL }] },
                { labels: [{ name: READY_FOR_MERGE_PR_LABEL }] },
        ...
        it('should not notify user if slack_webhook_url not provided', () => __awaiter(void 0, void 0, void 0, function* () {
            const queuedPrs = [{ labels: [{ name: READY_FOR_MERGE_PR_LABEL }] }];
            octokit.pulls.list.mockImplementation(({ page }) => __awaiter(void 0, void 0, void 0, function* () {
                return ({
                    data: page === 1 ? queuedPrs : []
            ...
            yield manageMergeQueue({ login });
            expect(notifyUser).not.toHaveBeenCalled();
        }));
        it('should not notify user if login not provided', () => __awaiter(void 0, void 0, void 0, function* () {
            const queuedPrs = [{ labels: [{ name: READY_FOR_MERGE_PR_LABEL }] }];
            octokit.pulls.list.mockImplementation(({ page }) => __awaiter(void 0, void 0, void 0, function* () {
                return ({
                    data: page === 1 ? queuedPrs : []
            ...
            yield manageMergeQueue({ slack_webhook_url });
            expect(notifyUser).not.toHaveBeenCalled();
        }));
    });
    describe('multiple pages of prs', () => {
        ...
        it('should call pulls.list for multiple pages', () => {
            expect(octokit.pulls.list).toHaveBeenCalledWith(Object.assign({ state: 'open', sort: 'updated', direction: 'desc', per_page: 100, page: 1 }, context.repo));
            expect(octokit.pulls.list).toHaveBeenCalledWith(Object.assign({ state: 'open', sort: 'updated', direction: 'desc', per_page: 100, page: 2 }, context.repo));
            expect(octokit.pulls.list).toHaveBeenCalledWith(Object.assign({ state: 'open', sort: 'updated', direction: 'desc', per_page: 100, page: 3 }, context.repo));
        });
        it('should call remove label with correct params', () => {
            expect(removeLabelIfExists).toHaveBeenCalledWith(READY_FOR_MERGE_PR_LABEL, 123);
            expect(removeLabelIfExists).toHaveBeenCalledWith('QUEUED FOR MERGE #1', 123);
...
//# sourceMappingURL=manage-merge-queue.test.js.map