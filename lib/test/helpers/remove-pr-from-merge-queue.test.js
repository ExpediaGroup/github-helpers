...
describe('removePrFromMergeQueue', () => {
    ...
    describe('should remove pr case', () => {
        beforeEach(() => {
            octokit.repos.listCommitStatusesForRef.mockImplementation(() => __awaiter(void 0, void 0, void 0, function* () {
                return ({
                    data: [
                        {
        ...
        it('should call listCommitStatusesForRef with correct params', () => {
            expect(octokit.repos.listCommitStatusesForRef).toHaveBeenCalledWith(Object.assign({ ref: 'correct sha' }, context.repo));
        });
...
//# sourceMappingURL=remove-pr-from-merge-queue.test.js.map