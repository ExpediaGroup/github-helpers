...
describe('createProjectCard without note', () => {
    ...
    beforeEach(() => {
        ...
        octokit.projects.listForRepo.mockImplementation(() => __awaiter(void 0, void 0, void 0, function* () {
            return ({
                data: [
                    {
                        owner_url: 'example owner url',
        ...
        octokit.projects.listColumns.mockImplementation(() => __awaiter(void 0, void 0, void 0, function* () {
            return ({
                data: [
                    {
                        url: 'a mock url',
        ...
        octokit.projects.createCard.mockImplementation(() => __awaiter(void 0, void 0, void 0, function* () {
            return ({
                data: {
                    url: 'card url',
                    id: 12345,
    ...
    it('should call createProjectCard with correct params and move the card to the bottom after created', () => {
        expect(octokit.projects.createCard).toHaveBeenCalledWith(Object.assign(Object.assign({ column_id: 1234, content_type: 'PullRequest', content_id: 123 }, context.repo), GITHUB_OPTIONS));
...
describe('createProjectCard with a note', () => {
    ...
    it('should associate the note information provided into the card', () => {
        expect(octokit.projects.createCard).toHaveBeenCalledWith(Object.assign(Object.assign({ column_id: 1234, note: 'This PR is adding an extra note due that we want to not add the PRs information' }, context.repo), GITHUB_OPTIONS));
        expect(octokit.projects.createCard).toHaveBeenCalledTimes(1);
    });
});
//# sourceMappingURL=create-project-card.test.js.map