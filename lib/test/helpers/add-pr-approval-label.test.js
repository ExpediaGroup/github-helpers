...
describe('addPrApprovalLabel', () => {
    describe('core approver case', () => {
        ...
        it('should add core approved label to the pr', () => {
            expect(octokit.issues.addLabels).toHaveBeenCalledWith(Object.assign({ labels: [CORE_APPROVED_PR_LABEL], issue_number: 123 }, context.repo));
        });
    });
    describe('peer approver case', () => {
        ...
        it('should add core approved label to the pr', () => {
            expect(octokit.issues.addLabels).toHaveBeenCalledWith(Object.assign({ labels: [PEER_APPROVED_PR_LABEL], issue_number: 123 }, context.repo));
        });
    });
});
//# sourceMappingURL=add-pr-approval-label.test.js.map