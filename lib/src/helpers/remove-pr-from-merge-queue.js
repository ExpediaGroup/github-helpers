...
export const removePrFromMergeQueue = ({ seconds }) => __awaiter(void 0, void 0, void 0, function* () {
    const { data: prData } = yield octokit.pulls.list(Object.assign({ state: 'open', per_page: 100 }, context.repo));
    ...
    const { data } = yield octokit.repos.listCommitStatusesForRef(Object.assign({ ref: sha }, context.repo));
...
//# sourceMappingURL=remove-pr-from-merge-queue.js.map