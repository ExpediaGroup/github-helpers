...
export const generatePathMatrix = ({ paths, globs, 
...
batches }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const changedFiles = yield getChangedFilepaths(context.issue.number);
...
//# sourceMappingURL=generate-path-matrix.js.map